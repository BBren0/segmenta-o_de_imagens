...
void setup() {
  ...
  imgOriginal = loadImage("imagem.png");  // Carrega a imagem original
  ...
  floodFill(edges, 250, 150, color(255), color(0)); 
...
PImage maskBackgroundToBlack(PImage source) {
  ...
  float threshold = 140;  // Define um limiar de similaridade para a cor do fundo
